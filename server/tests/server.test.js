...
describe('POST /users', () => {
	it('should create a user', (done) => {
		var email = 'ciaociao22@gmail.com';
		var password = 'ciaociaociao222';
		request(app)
			.post('/users')
			.send({email, password})
			.expect(200)
...
describe('DELETE /users/me/token', () => {
	it('should remove auth token of logout', () => {
		request(app)
